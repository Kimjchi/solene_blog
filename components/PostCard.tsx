...
const PostCard = ({isFeatured=false, image, excerpt, date, theme, title, url, index, tags, optionalClasses = ""}: postCardProps) => {
  ...
  return (
    <animated.div className={optionalClasses + classes + "shadow-lg p-3 relative bg-white w-full rounded-lg" + ( index % 2 === 0 ? " card" : " text-center yellow-border")} style={props}>
