  ...
  return (
    <div className='mt-3'>
        ...
        <div className='card flex flex-col h-60 shadow-lg rounded-lg p-3 relative bg-white relative space-y-2'>
            <textarea placeholder='Ajouter un commentaire' required className='green-border'/>
            <input placeholder='Nom*' type="text" required className='green-border w-1/4'/>
            <input placeholder='Adresse e-mail*' type="email" required className='green-border w-1/4'/>
