...
export default function OpaquePhoto({
  imageURL,
  title,
  location,
  date,
  ...
  return (
    <div
      className={
        "flex h-80 items-center justify-center relative" +
        (index % 3 === 0 ? " " : "")
      }
    ...
    >
      <a.div
        className="absolute overflow-hidden shadow-md pb-80 cursor-pointer will-change-transform w-full top-0"
